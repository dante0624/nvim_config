...
local parse = require("lint.parser").from_pattern
...
return {
	...
	args = {
		...
		"doctype-first,title-require,html-lang-require,"
			-- Attributes
			.. "attr-lowercase,attr-no-duplication,"
			.. "attr-no-unnecessary-whitespace,attr-unsafe-chars,"
			.. "attr-value-double-quotes,attr-value-not-empty,attr-sorted,"
			.. "alt-require,input-requires-label,"
			--Tags
			.. "tag-pair,tag-self-close,tagname-lowercase,"
			.. "tagname-specialchars,src-not-empty,"
			--ID
	...
	parser = parse(pattern, groups, severities, { source = linter_name }),
}
